...
def getModel():
    ...
    model = ASTGCN(device, cheb_polynomials, num_for_predict=opt.seq_len, len_input=opt.his_len, num_of_vertices=num_variable, in_channels=opt.channelin,
                  nb_block=2,  K=3, nb_chev_filter=64, nb_time_filter=64, time_strides=2).to(device)
